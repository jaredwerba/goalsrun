...
export const BRAND_PITCHES: BrandPitch[] = [
  {
    ...
    whyGoals:
      "At 43, I'm running times that weren't possible for me at 33 — and the shoes on my feet for all four of my marathon PRs were Nike. Boston 2026 sub-2:39 in the Alphafly 3. Ninety miles a week in Pegasus 41. Every pair paid for out of pocket.",
    whyNow:
      "Boston 2026 was my ceiling — sub-2:39 at 43. The next training block is aimed at 2:35. A masters athlete chasing a time nobody expects, in the shoes he already races in, is exactly the story Nike's running marketing is built to tell.",
    whyFirst:
  ...
  },
  {
    ...
    whyGoals:
      "Intervals are where most masters runners fall off — you can't hit the splits anymore, so you stop trying. I still hit them. Takumi Sen 10 on track days, Adios Pro on threshold days, and the 2:39 in Boston is partly because I never stopped training like I was 28.",
    whyNow:
  ...
  },
  {
    slug: "puma",
    brand: "Puma",
    tagline: "Cape Verdean kid, Puma poster on the wall, now racing sub-2:40.",
    heroImage: {
    ...
    whyGoals:
      "My parents immigrated from Cape Verde. I grew up with Puma posters on the wall. Signing the first Cape Verdean-American masters marathoner to a Puma running deal is a story that writes itself — Praia to Boston, 43 years old, sub-2:40.",
    whyNow:
      "Puma is pushing into US endurance with Nitro Elite and a new marathon program. I'm a Boston-based 2:39 masters runner with documented training, a home-city race on the calendar, and a heritage story your team can actually lean into. The timing does not repeat.",
    whyFirst:
  ...
  },
  {
    slug: "hoka",
    brand: "Hoka",
    tagline: "Men over 40 wear Hoka. I'm 43 and I'm running sub-2:40 in them.",
    heroImage: {
    ...
    whyGoals:
      "I am the story Hoka should be telling. 43 years old, 90 miles a week, Clifton 9 on easy long runs six days out of seven. I'm the customer and I'm also the athlete — that overlap is rare and it's the whole pitch.",
    whyNow:
      "Hoka's been chasing elite credibility for five years. Signing a 2:39 masters runner in Boston — the road-running capital of America — is category credibility without paying World Marathon Majors money for a 28-year-old pro. The masters marathon is the least-crowded story in running.",
    whyFirst:
  ...
  },
  {
    ...
    whyBrand:
      "Maurten changed marathon fueling. It's the only gel I take on race day because it's the only one my stomach tolerates at 5:50 pace. Sub-2:40 doesn't happen without it — not for me, and not for most of the athletes I coach.",
    whyGoals:
  ...
  },
  {
    ...
    brand: "New Balance",
    tagline:
      "Boston's hometown brand and a Boston masters runner at 2:39. Why hasn't this happened yet?",
    heroImage: {
      src: "/images/photo_085.jpg",
    ...
    whyGoals:
      "I'm not a global sub-2:10 elite. I'm the Boston-local masters runner your core customer actually looks like. A 43-year-old with a 2:39, a full-time life, and a coaching practice at Castle Island is more relatable than any sponsored pro on the roster.",
    whyNow:
  ...
  },
  {
    ...
    whyNow:
      "ASICS's US marketing is shifting back toward performance storytelling. A sub-2:40 masters runner in Boston with documented training, a Metaspeed on race day, and a coaching practice is the athlete story the brand is currently missing in the market.",
    whyFirst:
  ...
  },
  {
    ...
    brand: "Whoop",
    tagline:
      "Three years of Whoop data. 2:39 at 43 is what recovery-driven training looks like.",
    heroImage: {
      src: "/images/IMG_1570.jpeg",
    ...
    whyBrand:
      "Whoop is the recovery wearable that earned its place in elite sport. HRV, strain, sleep — the three variables that separate a 43-year-old who runs 2:39 from a 43-year-old who can't finish a 5K. The product actually works, and the data proves it.",
    whyGoals:
    ...
    whyNow:
      "Whoop is moving into performance and away from pure consumer wellness. A masters marathoner with three years of clean, continuous data and a sub-2:40 at 43 is the exact athlete story that proves HRV-guided training changes outcomes at a demographic your marketing is trying to reach.",
    whyFirst:
  ...
  },
  {
    ...
    brand: "Garmin",
    tagline:
      "Every mile, every interval, every race in Garmin. Forerunner 965 on my wrist for a sub-2:39.",
    heroImage: {
      src: "/images/photo_068.jpg",
    ...
    whyBrand:
      "The GPS watch that every serious runner I know wears. Garmin's Running Dynamics — cadence, vertical oscillation, ground contact time — are what I use to dial in form. They're the details that turn a 2:45 runner into a 2:39 runner.",
    whyGoals:
    ...
    whyNow:
      "Garmin is the overwhelming incumbent in the watch category — but the brand's athlete storytelling skews young and trail. A 43-year-old road marathoner with a 2:39 and three years of public Connect data broadens the Garmin narrative into the masters category your competitors are starting to chase.",
    whyFirst:
  ...
  },
  {
    ...
    whyFirst:
      "A Strava partnership for a 2:39 masters runner is the cleanest first brand deal possible — zero conflict, zero setup, instant authenticity. And every Strava post I make links back to the partnership brands that come next. The platform is the flywheel.",
  },
];
